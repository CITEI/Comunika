...
export const PASS_RESET_EXPIRATION = Number(
  process.env.PASS_RESET_EXPIRATION ?? 600
); // 10 minutes
...
export const APP_NAME = "Comunizika";
...
export const PUBLIC_PROJECT_PATH = PROJECT_PATH.replace(
  /((\\|\/)src|(\\|\/)dist)/g,
  ""
);
